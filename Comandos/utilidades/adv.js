...
module.exports = {
  ...
  async run(interaction, Client) {
    ...
    const ALTO_ESCALAO_ID = '1360756205206896880';
    ...
    if (interaction.isModalSubmit() && interaction.customId === 'adv_modal') {
      ...
      const canalAdvId = '1360756206674903074';
      ...
      const cargosAdvertencia = {
            'Verbal': '1360756204850118674',
             'Advertência 1': '1360756204850118673',
             'Advertência 2': '1360756204850118672',
             'Advertência 3': '1360756204850118671',
      };
      ...
      // Tenta enviar DM para o usuário advertido, se possível
      if (mentionedUser) {
        try {
