...
const CARGOS_PERMITIDOS = ['1360756205206896880', '1360756205206896874'];
...
client.on('messageCreate', async (message) => {
    ...
    if (message.content.startsWith('!relatorio')) {
        // Verifica se o membro possui algum dos cargos permitidos
        const temCargoPermitido = message.member.roles.cache.some(role =>
